...
func TestAssessActiveMR(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "missing MR with missing source is stale", reader: reader, input: ActiveMRInput{ActiveMR: "mr-missing", SourceIssueHint: "gt-missing"}, wantPend: false, wantSource: "gt-missing"},
		{name: "missing MR with no source hint is pending", reader: reader, input: ActiveMRInput{ActiveMR: "mr-missing"}, wantPend: true},
